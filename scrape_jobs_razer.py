...
if __name__ == "__main__":
	...
	for j in range(len(urls)):
		...
		if j == 0:
			df.to_csv(f"""C:\\Users\\Brian T\\Desktop\\web_scape_jobs\\jobs_{date.today()}.csv""",index=False)
		elif j > 0:
			df.to_csv(f"""C:\\Users\\Brian T\\Desktop\\web_scape_jobs\\jobs_{date.today()}.csv""", mode='a', header=False, index = False)
	print('Done')